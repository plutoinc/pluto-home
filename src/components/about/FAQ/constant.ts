...
export const FAQ_LIST: FaqType[] = [
  ...
  {
    question: "Why metadata database?",
    answer: [
  ...
  {
    question: "Why choose Research Intelligence instead of a search engine?",
    answer: [
  ...
  {
    question: "What differentiates us from a search engine?",
    answer: [
