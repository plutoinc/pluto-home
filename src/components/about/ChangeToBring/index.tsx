  ...
  return (
    <div className="bg-gradient-to-b from-0% to-100% from-pluto-dark-blue to-pluto-deep-blue">
      <MaxWidth className="space-y-8 py-16 text-white tablet:py-24 tablet:space-y-24">
        <ScrollMotionInView className="text-2xl font-medium tablet:text-5xl max-w-[72%] !leading-[1.3]">
          What kind of changes are we trying to bring about based on this tool?
        </ScrollMotionInView>
        <div className="space-y-8">
          <ScrollMotionInView className="space-y-8 desktop:grid desktop:grid-cols-3 desktop:gap-x-[30px] desktop:self-stretch desktop:space-y-0">
            <CardItem
          ...
          <ScrollMotionInView className="space-y-8 desktop:grid desktop:grid-cols-2 desktop:gap-x-8 desktop:space-y-0">
            <CardItem
